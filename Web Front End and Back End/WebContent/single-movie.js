...
function handleResult(resultData) {
    ...
    backInfoElement.append("<p><a href=index.html"+"?title="+replaceSpace(resultData[0]['mtitle'])+"&year="+resultData[0]['myear']+"&director="+resultData[0]['mdirector']+"&star="+resultData[0]['mstar']+"&firstRecord="+resultData[0]['mfirstRecord']+"&numRecord="+resultData[0]['mnumRecord']+"&sortType="+resultData[0]['msortType']+"&sortOrder="+resultData[0]['msortOrder']+"&title_i="+resultData[0]["mtitle_i"]+"&genre="+replaceSpace(resultData[0]["mgenre"])+">Back to Search Result</a></p>");
    ...
    for (let i = 0; i < resultData.length; i++) {
        let rowHTML = "";
        	...
        	rowHTML += createTheHtml(resultData[i]["star_id"],resultData[i]["movie_star"],replaceSpace(resultData[0]['mtitle']),resultData[0]['myear'],resultData[0]['mdirector'],resultData[0]['mstar'],resultData[0]['mfirstRecord'],resultData[0]['mnumRecord'],resultData[0]['msortType'],resultData[0]['msortOrder'],resultData[0]["mtitle_i"],resultData[0]["mgenre"],resultData[i]["stars_num"]);
