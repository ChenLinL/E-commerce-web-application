...
public class RedActivity extends ActionBarActivity {
    ...
    public void connectToTomcat(View view) {
        ...
        */
        ...
        final StringRequest loginRequest = new StringRequest(Request.Method.POST, "https://ec2-18-217-240-243.us-east-2.compute.amazonaws.com:8443/project4/api/login",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
